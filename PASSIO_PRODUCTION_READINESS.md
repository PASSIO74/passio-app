...
| **Suppression de compte** | ⚠️ **TROU CONNU** | **Elle ne cascade pas.** Mesuré le 2026-08-17 : 76 lignes `user_state`, 54 notifications et 19 fichiers médias (81 Mo) survivent à leur propriétaire. Les médias restent **servis** — URL publique récupérée sans aucun jeton → `200`, 249 Ko. Les tables de contenu, elles, sont propres (0 orpheline). Arbitrage produit à trancher (`MEDIA-COMPTE-SUPPRIME-010`) |
