...
Les treize pièges mesurés, le fil de découverte, le catalogue additif `SPECIALITES`/`SYNONYMES`, la migration des préférences et les corrections après essai réel : `docs/PREMIERE_VISITE.md`.
