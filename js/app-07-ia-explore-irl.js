Warning: truncated output (original token count: 70515)
Total output lines: 5801
...
function renderIRL() {
  ...
  list.innerHTML = filtered.map(e => {
    ...
    …20515 tokens truncated… = (serverList || []).concat(localOnly).map(_normalizeThreadComment);
  arr.length = 0;
