...
function feedWindowRememberScroll() {
  ...
  window._feedScrollAnchor = {
    ...
    // ⚠️ L'en-tête rétractable fait PARTIE de l'ancre : replié, il retire ~150 px
    // au-dessus du fil. Restaurer la position sans restaurer sa hauteur revient
    // à viser une page qui n'a pas la même géométrie — c'est la moitié haute des
    // sauts de 19 à 78 px relevés par la contre-revue.
    collapsed: scroller.classList.contains("chrome-collapsed"),
  };
}
...
function feedWindowRestoreScroll() {
  ...
  // bascule automatique le temps de converger, sans quoi chaque correction de
  // scroll la redéclenche et la cible bouge sous la correction.
