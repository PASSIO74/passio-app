...
function passioTextePolitique() {
  return '\
      ...
      <p style="margin:0 0 10px;"><strong style="color:var(--text);">6. Ce que ton navigateur appelle ailleurs.</strong> Afficher une carte, un GIF ou une image de démonstration fait appel à des services tiers qui reçoivent alors ton <strong style="color:var(--text);">adresse IP</strong> : fonds de carte (OpenFreeMap), recherche d\'adresse (Base Adresse Nationale, Photon), GIF (Giphy, Tenor), images et vidéos d\'illustration (Unsplash, Pexels), la police des titres à chaque ouverture (Google Fonts, Google LLC, États-Unis), et — pendant un appel ou un live vidéo seulement — le relais qui achemine le flux quand une connexion directe est impossible (Open Relay par Metered, États-Unis) ainsi que les serveurs STUN de Google. Nous ne leur transmettons ni ton compte, ni ton nom.</p>\
      ...
      <p style="margin:0 0 10px;"><strong style="color:var(--text);">9. Tes droits (RGPD).</strong> Accès, rectification, effacement, portabilité, limitation, opposition — et le droit de retirer ton consentement quand il en sert de base. Exerce-les dans l\'app (Paramètres → Confidentialité → <strong style="color:var(--text);">Exporter mes données</strong> pour l\'accès et la portabilité, en JSON, tout de suite ; Paramètres → Supprimer mon compte pour l\'effacement) ou par e-mail :<strong style="color:var(--text);">' + _legalEscapeHtml(PASSIO_EDITEUR.email) + '</strong>. Nous répondons sous un mois. Tu peux aussi réclamer auprès de la CNIL (cnil.fr).</p>\
      ...
      <p style="margin:0;"><strong style="color:var(--text);">11. Service en évolution.</strong> PASSIO est jeune : les fonctionnalités évoluent et <strong style="color:var(--text);">tes contenus peuvent être perdus</strong> : n\'y dépose rien d\'irremplaçable. Tes retours peuvent être utilisés pour améliorer le produit.</p>\
  ';
}
