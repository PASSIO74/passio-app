  ...
  overview() {
    ...
    return {
      totals: {
        ...
        publications: count((e) => e.action === "publish_post" || e.action === "publish_reel"),
        messages: count((e) => e.action === "send_message"),
        comments: count((e) => e.action === "comment_post"),
        reactions: count((e) => /react|like_post/.test(e.action || "")),
        notifications: count((e) => /notif/.test(e.action || "")),
