...
| [ADR-012](../adr/ADR-012-canal-acces-base-de-donnees.md) | **Un canal de lecture** (connecteur claude.ai, `read_only`), **un canal d'écriture** ; `supabase db query --linked` retiré | Accepté |
