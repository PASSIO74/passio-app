...
| **SMTP (Brevo)** | Notifications | prod | **RÉEL** (2026-08-30) | SMTP Supabase (jamais dans le dépôt) | confirmation e-mail, réinitialisation de mot de passe | 300/jour (offre gratuite) | Port 587 STARTTLS, expéditeur « PASSIO ». **Depuis le 2026-09-11 : compte Brevo PASSIO (passioadmin@gmail.com) et domaine d'envoi `passio-app.fr` (OVH, compte PASSIO)** ; DKIM/DMARC **posés et résolus**, SMTP Supabase **basculé** sur `contact@passio-app.fr` (mesuré le 2026-09-11 soir, `docs/SETUP_SMTP_AUTH.md`) ; preuve de livraison par une inscription réelle **encore à faire** (`dkim=pass`). Gabarits d'e-mail en français. |
